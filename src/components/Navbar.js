	...
	return (
		<div className="custom_navbar container_padding_x">
			...
			<div className="section_links">
				<ul>
					<li>
						<Link className="link" to="story" spy={true} smooth={true} offset={50} duration={200}>
							Story
						</Link>
					</li>

					<li>
						<Link className="link" to="roadmap" spy={true} smooth={true} offset={50} duration={200}>
							roadmap
						</Link>
					</li>

					<li>
						<Link className="link" to="showcase" spy={true} smooth={true} offset={50} duration={200}>
							ShowCase
						</Link>
					</li>

					<li>
						<Link className="link" to="team" spy={true} smooth={true} offset={50} duration={200}>
							team
						</Link>
					</li>

					<li>
						<Link className="link" to="faq" spy={true} smooth={true} offset={50} duration={200}>
							faq
						</Link>
					</li>

					<li>
						<Link className="link" to="contact" spy={true} smooth={true} offset={50} duration={200}>
							contact
						</Link>
					</li>
				</ul>
					...
					<ul>
						...
						<li>
							<div className="sm_social_links">
								<div className="icon_container">
								<AiFillInstagram className="icon" />
								<a href="http://twitter.com/bayc2819"></a>
								</div>
								<div className="icon_container">
									<BsTwitter className="icon" />
								</div>
