...
contract DinoNFTs is ERC721Enumerable, Ownable {
  ...
  uint256 public maxMintAmount = 5; // one user can mint only 10 nfts 
 ...
 // msg.sender means you (the deployer )
  ...
  function mint(address _to, uint256 _mintAmount) public payable { //Mint function
    ...
    require(supply + _mintAmount <= maxSupply,"We have only 2222 NFTs "); // check user set NFTs lower than maxSupply
